...
Route::post('/save-pdf-method', [OutcomeAssessmentController::class, 'savepdf'])->name('save.pdf.date');
...
Route::get('/skilled-agency/non-skilled-soc/{id}', [SkilledAgencyController::class, 'Nonskilledoasis'])->name('skilled-agency.non-skilled-oasis-start-of-care');
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/patient-emergency-contact/ajax/pull', [PatientEmergencyPrecedenceController::class, 'PatientEmergencyContactAjax'])->name('patients.patient-emergency-contact.ajax');
    Route::post('/patient-emergency-contact/print', [PDFController::class, 'PatientEmergencyContact'])->name('patient-emergency-contact.print');
    ...
    Route::post('/patient-startofcare/print', [PDFController::class, 'PatientStartOfCare'])->name('patients.startofcare.print');

    // Plan of Care History
    Route::get('/patient-plan-of-care/ajax/pull', [PhysicianController::class, 'PatientPlanOfCareAjax'])->name('patients.plan-of-care.ajax');
    Route::post('/patient-plan-of-care/print', [PDFController::class, 'PatientPlanOfCare'])->name('patients.plan-of-care.print');

    // Patient Discharge List
    Route::get('/patient-discharge-list/ajax/pull', [PatientDischargeController::class, 'PatientDischargeListAjax'])->name('patients.discharge-list.ajax');
    Route::post('/patient-discharge-list/print', [PDFController::class, 'PatientDischargeList'])->name('patients.discharge-list.print');

    // Patient Infection List
    Route::get('/patient-infection-list/ajax/pull', [InfectionController::class, 'PatientInfectionListAjax'])->name('patients.infection-list.ajax');
    Route::post('/patient-infection-list/print', [PDFController::class, 'PatientInfectionList'])->name('patients.infection-list.print');

    // Drug Interaction
    // Route::get('/drug-interaction/ajax/pull', [InfectionController::class, 'DrugInteractionAjax'])->name('drug-interaction.ajax');
    // Route::post('/drug-interaction/print', [PDFController::class, 'DrugInteractionList'])->name('drug-interaction.print');
