...
class TemplatesController extends Controller
{
    ...
    public function create()
    {
        ...
        // return view('templates.create', compact('new_goals', 'new_interventions', 'section_gg_functional_abilities', 'section_g_functional_status', 'bims_summary_scores'));
    ...
    public function store(Request $request)
    {
        ...
        Template::create([
            'new_goals_templates' => json_encode($validated['new_goals']),
            'template_new_goals_content' => $validated['new_goal_content'],
            'template_new_intervention_content' => $validated['new_intervention_content'],
            'new_intervention_templates' => json_encode($validated['new_interventions']),
