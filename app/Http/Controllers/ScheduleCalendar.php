...
class ScheduleCalendar extends Controller
{
    ...
    public function formOpen($data) {
        ...
        switch ($schedule->task) {
            ...
            case 'HHA Plan Of Care':
                return view('Skilled-Agency.plan-of-care');
            case 'Non-Oasis-SOC':
                return view('Skilled-Agency.non-skilled-oasis-start-of-care');
            ...
            case 'Custome POC':
                return view('Skilled-Agency.custome-poc');
            case 'Fall Risk Assessment':
                return view('Skilled-Agency.fall-risk-assessment');
            case 'Plan Of Care':
                return view('Skilled-Agency.plan-of-care');  
            case 'Post Fall Evaluation':
                return view('Skilled-Agency.post-fall-evaluation');              
