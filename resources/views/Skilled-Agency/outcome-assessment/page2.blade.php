        ...
        <input type="hidden" name="patient_history_id" value="{{$patient->id}}">
         ...
         <tr>
            <td><label class="form-check-label">
               <input type="checkbox" name="hispanic" class="form-check-input" @if(!empty($race_enc) && in_array('No, not of Hispanic, Latino/a, or Spanish origin', $race_enc)) checked @endif> A. No, not of Hispanic, Latino/a, or Spanish origin</label></td>
            </tr>
            <tr>
               <td><label class="form-check-label">
                  <input type="checkbox" name="mexican" class="form-check-input" @if(!empty($race_enc) &&  in_array('Yes, Mexican, Mexican American, Chicano/a', $race_enc)) checked @endif> B. Yes, Mexican, Mexican American, Chicano/a</label></td>
            </tr>
            <tr>
               <td><label class="form-check-label">
                <input type="checkbox" name="rican" class="form-check-input" @if(!empty($race_enc) &&  in_array('Yes, Puerto Rican', $race_enc)) checked @endif> C. Yes, Puerto Rican</label></td>
            </tr>
            <tr>
               <td>
                <label class="form-check-label">
                <input type="checkbox" name="cuban" class="form-check-input" @if( !empty($race_enc) && in_array('Yes, Cuban', $race_enc)) checked @endif> D. Yes, Cuban</label>
            </td>
            </tr>
            <tr>
               <td><label class="form-check-label">
                <input type="checkbox" name="anotherHispanic" class="form-check-input" @if( !empty($race_enc) && in_array('Yes, another Hispanic, Latino, or Spanish origin', $race_enc)) checked @endif> E. Yes, another Hispanic, Latino, or Spanish origin</label></td>
            </tr>
            <tr>
               <td><label class="form-check-label">
                <input type="checkbox" name="unableRespond" class="form-check-input" @if( !empty($race_enc) && in_array('Patient unable to respond', $race_enc)) checked @endif> X. Patient unable to respond</label></td>
            </tr>
            <tr>
               <td><label class="form-check-label"><input type="checkbox" name="declines" class="form-check-input" @if( !empty($race_enc) && in_array('Patient declines to respond', $race_enc)) checked @endif> Y. Patient declines to respond</label></td>
            </tr>
