               ...
               <div class="col-md-6 border d-flex flex-column py-2 px-2" >
                   ...
                   <div class="d-flex flex-row justify-content-between" style="font-size: 11px;">
                       <div class="d-flex flex-column col-md-4">
                           <div class="">
                               1 <input type="checkbox" name="funcitonalLimition" id="amputation" value="1" {{ !empty($patient->functionalAbilitie->amputation) && $patient->functionalAbilitie->amputation == 1 ? 'checked' : '' }}>
