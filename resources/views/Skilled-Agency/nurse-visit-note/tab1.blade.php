    ...
    <div class="container">
        <form action="{{ route('medication.discontinue.store') }}" method="POST">
            ...
            <div class="medication-content">
                ...
                <div class="row mt-5">
                    <div class="flex items-center gap-[15px]">
                        <button type="submit" class="form-control btn btn-primary !bg-[#4133BF] text-[#fff]">Save & Continue
                        </button>
                        <button type="button" class="form-control btn btn-primary !bg-[#4133BF] text-[#fff]">Save & Exit
                        </button>
                    </div>
                </div>
            </div>
