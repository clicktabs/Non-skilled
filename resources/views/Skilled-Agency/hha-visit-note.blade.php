                 ...
                 <tr>
                    ...
                    <td class="ps-0">
                       <div class="input-group clean-input-group" for="date_2">
                          ...
                          <input type="date" id="" class="form-control" name="date_2" id="date_2">
                       </div>
                    </td>
                    <td class="ps-0">
           ...
           <table class="table table-bordered default-td mb-0">
                    ...
                    <table class="table table-bordered align-middle default-td">
                       ...
                       <tr>
                          <td class="labels-group">
                             <label class="form-check-label" for=""><input type="radio" name="bath" id="bath_1" value="Tube" class="form-check-input">Tube</label>
                             <label class="form-check-label" for=""><input type="radio" name="bath" id="bath_2" value="Shower" class="form-check-input">Shower</label>
                          </td>
                          <td class="text-center"><input type="checkbox" class="form-check-input" name="refused_4" id="refused_4" value="1"></td>
                          <td><input type="text" class="form-control" name="comments_4" id="comments_4" value=""></td>
                       </tr>
                       <tr>
                          <td class="labels-group">
                             <span><b>Bed Batch:</b>&nbsp;&nbsp;</span>
                             <label class="form-check-label" for="bed_bath_1"><input type="radio" name="bed_bath" id="bed_bath_1" value="Partial" class="form-check-input"> Partial</label>
                             <label class="form-check-label" for="bed_bath_2"><input type="radio" name="bed_bath" id="bed_bath_2" value="Complete" class="form-check-input"> Complete</label>
                          </td>
                          <td class="text-center"><input type="checkbox" class="form-check-input" name="refused_5" id="refused_5" value="1"></td>
                          <td><input type="text" class="form-control" name="comments_5" id="comments_5" value=""></td>
                       </tr>
                       <tr>
                          <td class="labels-group">
                             <label class="form-check-label" for="assis_bath_chair"><input type="radio" name="assis_bath_chair_1" id="assis_bath_chair" value="Assist Bath-Chair" class="form-check-input_1">
                             Assist Bath - Chair</label>
                          </td>
                          <td class="text-center"><input type="checkbox" class="form-check-input" name="assis_bath_chair_2" id="assis_bath_chair_2" value="1"></td>
                       ...
                       <tr>
                          <td><label class="form-check-label" for="assist_with_dressing"><input type="checkbox" name="assist_with_dressing" id="assist_with_dressing" value="1" class="form-check-input"> Assist with Dressing</label></td>
                          <td class="text-center"><input type="checkbox" class="form-check-input" name="assist_with_dressing_1" id="assist_with_dressing_1" value="1"></td>
                          <td><input type="text" class="form-control" name="comments_8" id="comments_8" value=""></td>
                       </tr>
                       <tr>
                          <td><label class="form-check-label" for="hair_care"><input type="checkbox" name="hair_care" id="hair_care" value="1" class="form-check-input"> Hair Care</label></td>
                          <td class="text-center"><input type="checkbox" class="form-check-input" name="hair_care_1" id="hair_care_1" value="1"></td>
                          <td><input type="text" class="form-control" name="comments_9" id="comments_9" value=""></td>
                       </tr>
                       <tr>
                          <td><label class="form-check-label" for="shampoo"><input type="checkbox" name="shampoo" id="shampoo" value="1" class="form-check-input"> Shampoo</label></td>
                          <td class="text-center"><input type="checkbox" class="form-check-input" name="shampoo_1" id="shampoo_1" value="1"></td>
                          <td><input type="text" class="form-control" name="comments_11" id="comments_11" value=""></td>
                       </tr>
                       <tr>
                          <td><label class="form-check-label" for="skin_care"><input type="checkbox" name="skin_care" id="skin_care" value="1" class="form-check-input"> Skin Care</label></td>
                          <td class="text-center"><input type="checkbox" class="form-check-input" name="skin_care_1" id="skin_care_1" value="1"></td>
                          <td><input type="text" class="form-control" name="comments_12" id="comments_12" value=""></td>
                       </tr>
                       <tr>
                          <td><label class="form-check-label" for="moisturizer"><input type="checkbox" name="moisturizer" id="moisturizer" value="1" class="form-check-input"> Moisturizer</label></td>
                          <td class="text-center"><input type="checkbox" class="form-check-input" name="moisturizer_1" id="moisturizer_1" value="1"></td>
                          <td><input type="text" class="form-control" name="comments_13" id="comments_13" value=""></td>
                       </tr>
                       <tr>
                          <td><label class="form-check-label" for="foot_care"><input type="checkbox" name="foot_care" id="foot_care" value="1" class="form-check-input"> Foot Care</label></td>
                          <td class="text-center"><input type="checkbox" class="form-check-input" name="foot_care_1" id="foot_care_1" value="1"></td>
                          <td><input type="text" class="form-control" name="comments_14" id="comments_14" value=""></td>
                       </tr>
                       <tr>
                          <td><label class="form-check-label" for="check_pressure_areas"><input type="checkbox" name="check_pressure_areas" id="check_pressure_areas" value="1" class="form-check-input"> Check Pressure Areas</label></td>
                          <td class="text-center"><input type="checkbox" class="form-check-input" name="check_pressure_areas_1" id="check_pressure_areas_1" value="1" ></td>
                          <td><input type="text" class="form-control" name="comments_15" id="comments_15" value=""></td>
                       </tr>
                       <tr>
                          <td><label class="form-check-label" for="nail_care"><input type="checkbox" name="nail_care" id="nail_care" value="1" class="form-check-input"> Nail Care</label></td>
                          <td class="text-center"><input type="checkbox" class="form-check-input" name="nail_care_1" id="nail_care_1" value="1"></td>
                          <td><input type="text" class="form-control" name="comments_16" id="comments_16" value=""></td>
                       </tr>
                       <tr>
                          <td><label class="form-check-label" for="oral_care"><input type="checkbox" name="oral_care" id="oral_care" value="1" class="form-check-input"> Oral Care</label></td>
                          <td class="text-center"><input type="checkbox" class="form-check-input" name="oral_care_1" id="oral_care_1" value="1"></td>
                          <td><input type="text" class="form-control" name="comments_17" id="comments_17" value=""></td>
                       </tr>
                       <tr>
                          <td><label class="form-check-label" for="clean_dentures"><input type="checkbox" name="clean_dentures" id="clean_dentures" value="1" class="form-check-input"> Clean Dentures</label></td>
                          <td class="text-center"><input type="checkbox" class="form-check-input" name="clean_dentures_1" id="clean_dentures_1" value="1"></td>
                       </tr>
                       <tr>
                          <td><label class="form-check-label" for="shave"><input type="checkbox" name="shave" id="shave" value="1" class="form-check-input"> Shave</label></td>
                          <td class="text-center"><input type="checkbox" class="form-check-input" name="shave_1" id="shave_1" value="1"></td>
                    ...
                    <table class="table table-bordered align-middle default-td">
                       ...
                       <tr>
                          <td class="labels-group">
                             ...
                             <label class="form-check-label" for="ambulation" ><input type="checkbox" name="ambulation" id="ambulation" value="ambulation" class="form-check-input"> Ambulation</label>
                             <label class="form-check-label" for="w_c"><input type="checkbox" name="w_c" id="" value="w_c" class="form-check-input"> W/C</label>
                             <label class="form-check-label" for="walker"><input type="checkbox" name="walker" id="walker" value="walker" class="form-check-input"> Walker</label>
                             <label class="form-check-label" for="cane"><input type="checkbox" name="cane" id="" value="cane" class="form-check-input"> Cane</label>
                          </td>
                          <td class="text-center"><input type="checkbox" class="form-check-input" name="refuse_11" id="refuse_11" value="1"></td>
                          <td><input type="text" class="form-control" name="comments_30" id="comments_30" value=""></td>
                       </tr>
                       <tr>
                          <td class="labels-group">
                             <span><b>Assist with Mobility:</b>&nbsp;&nbsp;</span>
                             <label class="form-check-label" for="gait_belt"><input type="checkbox" name="gait_belt" id="gait_belt" value="1" class="form-check-input"> Gait Belt</label>
                             <label class="form-check-label" for="chair"><input type="checkbox" name="chair" id="" value="1" class="form-check-input"> Chair</label>
                             <label class="form-check-label" for="bed"><input type="checkbox" name="bed" id="bed" value="1"class="form-check-input"> Bed</label>
                             <label class="form-check-label" for="dangle"><input type="checkbox" name="dangle" id="dangle" value="1" class="form-check-input"> Dangle</label>
                             <label class="form-check-label" for="commod"><input type="checkbox" name="commod" id="commod" value="1"class="form-check-input"> Commode</label>
                             <label class="form-check-label" for="shower"><input type="checkbox" name="shower" id="shower" value="1" class="form-check-input"> Shower</label>
                             <label class="form-check-label" for="tub"><input type="checkbox" name="tub" id="tub" value="1" class="form-check-input"> Tub</label>
                          </td>
                          <td class="text-center"><input type="checkbox" class="form-check-input" name="refuse_13" id="" value="1"></td>
                          <td><input type="text" class="form-control" name="comments_31" id="comments_31" value=""></td>
                       </tr>
                       <tr>
                          <td class="labels-group">
                             <span><b>ROM:</b>&nbsp;&nbsp;</span>
                             <label class="form-check-label" for="active"><input type="radio" name="ROM" class="form-check-input" id="active" value="active"> Active</label>
                             <label class="form-check-label" for="passive"><input type="radio" name="ROM" class="form-check-input" id="passive" value="passive"> Passive</label>
                             <br>
                             <span><b>Arm:</b>&nbsp;&nbsp;</span>
                             <label class="form-check-label" for="arm_r"><input type="radio" name="Arm" class="form-check-input" id="arm_r" value="r"> R</label>
                             <label class="form-check-label" for="arm_l"><input type="radio" name="Arm" class="form-check-input" id="arm_l" value="l"> L</label>
                             <br>
                             <span><b>Leg:</b>&nbsp;&nbsp;</span>
                             <label class="form-check-label" for="leg_r"><input type="radio" name="Leg" class="form-check-input" id="eg_r" value="r"> R</label>
                             <label class="form-check-label" for="leg_l"><input type="radio" name="Leg" class="form-check-input" id="leg_l" value="l"> L</label>
                          </td>
                          <td class="text-center"><input type="checkbox" class="form-check-input" name="refused_14" id="refused_14" value="1"></td>
                          <td><input type="text" class="form-control" name="comments_32" id="comments_32" value=""></td>
                       </tr>
                       <tr>
                          <td>
                             <div class="d-block"><label class="form-check-label" for="encourange_reposition"><input type="checkbox"  name="reposition" id="encourange_reposition" value="1" class="form-check-input"> Reposition</label></div>
                             <div class="d-block"><label class="form-check-label" for="encourange_reposition"><input type="checkbox"  name="reposition" id="encourange_reposition" value="1" class="form-check-input"> Encourage Position Change</label></div>
                             <div class="input-group clean-input-group">
                          ...
                          <td class="text-center"><input type="checkbox" class="form-check-input" name="refused_15" id="refused_15" value="1"></td>
                          <td><input type="text" class="form-control" name="comments_33" id="comments_33" value=""></td>
                       </tr>
                       <tr>
                          <td class="labels-group">
                             <span><b>Exercise - Per:</b>&nbsp;&nbsp;</span>
                             <label class="form-check-label" for="exercise_pt"><input type="checkbox" name="exercise_pt" id="exercise_pt" value="pt" class="form-check-input"> PT</label>
                             <label class="form-check-label" for="exercise_ot"><input type="checkbox" name="exercise_ot" id="exercise_ot" value="ot" class="form-check-input"> OT</label>
                             <label class="form-check-label" for="exercise_slp"><input type="checkbox" name="exercise_slp" id="exercise_slp" value="slp" class="form-check-input"> SLP Care Plan</label>
                          </td>
                          <td class="text-center"><input type="checkbox" class="form-check-input" name="refused_17" id="refused_17" value="1"></td>
                       ...
                       <tr>
                          ...
                          <td class="text-center"><input type="checkbox" class="form-check-input" name="refused_18" id="refused_18" value="1"></td>
                       ...
                       <tr>
                          <td class="labels-group">
                             <label class="form-check-label" for="limit"><input type="radio" name="radio_1" id="limit" value="Limit" class="form-check-input"> Limit</label>
                             <label class="form-check-label" for="encourage_fluides"><input type="radio" name="radio_1" id="encourage_fluides" value="Encourage Fluides" class="form-check-input"> Encourage Fluides</label>
                          </td>
                          <td class="text-center"><input type="checkbox" class="form-check-input" name="refused_21" id="refused_21" value="1"></td>
                       ...
                       <tr>
                          ...
                          <td class="text-center"><input type="checkbox" class="form-check-input" name="refused_22" id="refused_22" value="1"></td>
                       ...
                       <tr>
                          ...
                          <td class="text-center"><input type="checkbox" class="form-check-input" name="refused_23" id="refused_23" value="1"></td>
                       ...
                       <tr>
                          <td class="labels-group">
                             ...
                             <label class="form-check-label" for="bedroom"><input type="checkbox" name="bedroom" id="bedroom" value="1" class="form-check-input"> Bedroom</label>
                             <label class="form-check-label" for="bathroom"><input type="checkbox" name="bathroom" id="bathroom" value="1" class="form-check-input"> Bathroom</label>
                             <label class="form-check-label" for="kitchen"><input type="checkbox" name="kitchen" id="kitchen" value="1" class="form-check-input"> Kitchen</label>
                             <label class="form-check-label" for="change_bed_linen"><input type="checkbox" name="change_bed_linen" id="change_bed_linen" value="1" class="form-check-input"> Change Bed Linen</label>
                          </td>
                          <td class="text-center"><input type="checkbox" class="form-check-input" name="refused_25" id="refused_25" value="1"></td>
                       ...
                       <tr>
                          ...
                          <td class="text-center"><input type="checkbox" class="form-check-input" name="refused_26" id="refused_26" value="1"></td>
                       ...
                       <tr>
                          ...
                          <td class="text-center"><input type="checkbox" class="form-check-input" name="refused_27" id="refused_27" value="1"></td>
              ...
              <tr>
                 <td colspan="2" class="text-center labels-group">
                    ...
                    <label class="form-check-label" for="sn"><input type="checkbox" name="sn" id="sn" value="sn"ame="" class="form-check-input"> SN</label>
                    <label class="form-check-label" for="therapy"><input type="checkbox" name="therapy" id="therapy" value="therapy" class="form-check-input"> Therapy</label>
                    <label class="form-check-label" for="therapy"><input type="checkbox" name="pt" id="pt" value="pt" class="form-check-input"> PT</label>
                    <label class="form-check-label" for="ot"><input type="checkbox" name="ot" id="ot" value="ot" class="form-check-input"> OT</label>
                    <label class="form-check-label" for="slp"><input type="checkbox" name="slp" id="slp" value="slp" class="form-check-input"> SLP</label>
                    <label class="form-check-label" for="family"><input type="checkbox" name="family" id="family" value="family" class="form-check-input"> Family</label>
                    <label class="form-check-label" for="patient"><input type="checkbox" name="patient" id="patient" value="patient" class="form-check-input"> Patient</label>
                 </td>
              </tr>
              <tr><td colspan="2" class="p-0"></td></tr>
              <tr>
