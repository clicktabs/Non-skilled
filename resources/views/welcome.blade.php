...
<nav class="bg-[#2c3e75] fixed w-full z-20 top-0 left-0" x-data="{ show: false }">
...
<div class="bg-[#efefef] py-[30px] mb-[50px]">
    <div class="container mx-auto">
        <div class="header text-center">
            <h2 class="text-[35px] text-[#2c3e75] mb-[8px] font-[700]">Click-Tabs Solutions Emphasizes on</h2>
...
<div class="success_stories mb-[45px] mt-[5px]">
    <div class="container mx-auto">
        <div class="header text-center">
            <h2 class="text-[#2c3e75] text-[35px] mb-[8px] font-[700]">Empowering Home Healthcare Agencies!!!</h2>
        ...
        <div class="flex items-center gap-[40px] mt-[40px] flex-wrap md:flex-nowrap">
            <div>
                ...
                {{--                <div class="mt-[10px]">--}}
                {{--                    <p class="text-[18px] font-[600] mb-[15px] text-[#2c3e75]">Bill Dombi, President</p>--}}
...
<div class="success_stories mb-[60px]">
    <div class="container mx-auto">
        <div class="header text-center">
            <h2 class="text-[35px] text-[#2c3e75] mb-[10px] font-[700]">Healthcare Made Easy</h2>
        ...
        <div class="flex items-center gap-[60px] mt-[40px] flex-wrap md:flex-nowrap">
            <div>
                ...
                {{--                <div class="mt-[25px]">--}}
                {{--                    <p class="text-[18px]">Palliative Care in CMMI Programs</p>--}}
                {{--                    <a class="text-[0.8rem] text-[#2c3e75]" href="#">Read More ⟶</a>--}}
                {{--                </div>--}}
            </div>
            <div>
                <div class="overflow-hidden img rounded-[10px] shadow-[1px_1px_4px_rgba(0_0_0_0.2)]">
    ...
    <div class="container mx-auto">
        <div class="xl:flex block gap-[40px] content-center py-[30px] flex-wrap">
            <div class="py-[50px] mr-auto flex-shrink-0 xl:items-start items-center justify-center flex flex-col">
                <div>
                    <h2 class="text-[#2c3e75] text-[2.2rem] xl:text-left text-center font-[300] mb-[10px] font-[700]">The Ultimate Solution - EMR</h2>
                    <p class="text-[18px] xl:text-left text-center leading-[28px] font-[700]">For Home Healthcare? trust Click-Tabs.</p>
                </div>
                <div class="inline-flex">
                    <button data-video="h2n2l3iFC3s" class="modal-button bg-[#2c3e75] text-center text-[#fff] mt-[30px] block px-[60px] py-[12px] border-[3px] border-[#2c3e75] hover:bg-[#fff] hover:text-[#2c3e75] rounded-[5px] ml-0">See Demo</button>
                </div>
            </div>
        ...
        {{--            <div class="py-[50px]">--}}
        {{--                <div>--}}
        {{--                    <h2 class="text-[#2c3e75] text-[2.2rem] font-[300] mb-[10px] font-[700]">The Ultimate Solution - EMR</h2>--}}
        {{--                    <p class="text-[18px] leading-[28px]">For Home Healthcare? trust Click-Tabs.</p>--}}
        {{--                </div>--}}
        {{--                <div>--}}
        {{--                    <a class="bg-[#2c3e75] text-center text-[#fff] mt-[30px] block px-[60px] py-[12px] border-[3px] border-[#2c3e75] hover:bg-[#fff] hover:text-[#2c3e75] rounded-[5px]" href="#">See Demo</a>--}}
        {{--                </div>--}}
        {{--            </div>--}}
...
<section class="footer bg-[#2c3e75] pt-[30px]">
    <div class="container mx-auto">
        <div class="flex items-center justify-center flex-wrap flex-row">
            ...
            <div class="right xl:pl-[20px] text-center xl:text-left">
                ...
                <a class="text-[16px] text-[#2c3e75] rounded-[3px] py-[5px] px-[10px] bg-[#fff] xl:text-center" href="#">Subscribe Today</a>
            </div>
        </div>
    </div>
                ...
                <div class="md:mt-0 md:mb-auto">
                    ...
                    <div class="social mt-[20px] pt-[20px] border-t-[1px] border-[#7F7F7F] ">
                        <ul class="flex items-center gap-[5px] md:justify-center">
                            <li><a class="inline-flex w-[28px] h-[28px] bg-[#575757] p-[7px] hover:bg-[#2c3e75] " href="#"><img class="w-[14px] h-[14px]" src="{{asset('assets/images/youtube-social.png')}}"></a> </li>
                            <li><a class="inline-flex w-[28px] h-[28px] bg-[#575757] p-[7px] hover:bg-[#2c3e75] " href="#"><img class="w-[14px] h-[14px]" src="{{asset('assets/images/twitter-social.png')}}"></a> </li>
                            <li><a class="inline-flex w-[28px] h-[28px] bg-[#575757] p-[7px] hover:bg-[#2c3e75] " href="#"><img class="w-[14px] h-[14px]" src="{{asset('assets/images/linkedin-social.png')}}"></a> </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="footer-copyright py-[10px] bg-[#2c3e75] text-center">
