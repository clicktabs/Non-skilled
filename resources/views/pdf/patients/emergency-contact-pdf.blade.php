            ...
            @if ($contacts)
                ...
                @foreach ($contacts as $key => $contact)
                    {{++$key}}
                        ...
                        <td>
                            <p>{{$contact->id}}. Contact Name: <b>{{$contact->name}}</b></p>
                            <p>Phone: <b><u>{{$contact->phone}}</u></b></p>
                            <p>Patient Name: <b>{{$contact->patient->first_name . ' ' . $contact->patient->last_name }} ({{$contact->patient->gender=='female' ? 'F' : 'M'}})</b></p>

                            @if ($contact->relationship_to_patient)
                                <p>Relationship: <b>{{ucwords($contact->relationship_to_patient)}}</b></p>
                            @endif
