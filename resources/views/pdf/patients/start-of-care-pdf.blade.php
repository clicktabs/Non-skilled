            ...
            @if ($episodes)
                ...
                @foreach ($episodes as $key => $episode)
                    {{++$key}}
                        ...
                        <td>
                            <p>{{$episode->id}}. <b>Patient Name:</b> {{$episode->patient->first_name . ' ' . $episode->patient->last_name}} ({{$episode->patient->gender=='female' ? 'F' : 'M'}})</p>

                            <p><b>MRN#</b> {{$episode->patient->patient_code}}</p>

                            @if ($episode->patient->social_security_no)
                                <p><b>SSN:</b> {{$episode->patient->social_security_no}}</p>
                            @endif
                            
                            @if ($episode->patient->date_of_birth)
                                <p><b>Date of Birth:</b> {{$episode->patient->date_of_birth}}</p>
                            @endif

                            @if ($episode->start_of_care_date)
                                <p><b>SOC Date:</b> {{$episode->start_of_care_date}}</p>
                            @endif

                            @if ($episode->episode_start_date)
                                <p><b>EOC Date:</b> {{$episode->episode_start_date}}</p>
                            @endif
                        </td>
