    ...
    <script>
        ...
        jQuery('#same_home_address').click(function () {
            if (jQuery(this).is(':checked')) {
                ...
                jQuery('#p_s_phone').val(jQuery('#p_h_phone').val());
                jQuery('#p_s_alternate_phone').val(jQuery('#p_h_alternate_phone').val());
            } else {
                ...
                jQuery('#p_s_lat').val();
                jQuery('#p_s_lon').val();
                jQuery('#p_s_phone').val();
                jQuery('#p_s_alternate_phone').val();
            }
        });
