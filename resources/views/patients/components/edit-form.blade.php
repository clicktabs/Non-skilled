...
<div class="vt card mb-2 tabcontent" id="physician">
    <form name="patientPhysicianForm" id="patientPhysicianForm" name="patientPhysicianForm" method="POST">
        @csrf
        <div class="card-header text-center !bg-[#4133BF]">
        ...
        <div class="card-body">
            ...
            @php
                $attendingPhysician = $physicians->where('id', $pat->extra_info->physician_id)->first();
            @endphp
            <div class="mt-4">
                <div class="col">
                    <label for="physician_name">Physician Name:</label>
                    <span id="physician_name">
                        {{ (!empty($attendingPhysician->first_name) || !empty($attendingPhysician->last_name)) ? $attendingPhysician->first_name.' '.$attendingPhysician->last_name : 'No Physician Available' }}
                    </span>

                </div>
                <div class="col">
                    <label for="physician_address">Address:</label>
                    <span id="physician_address">{{ !empty($attendingPhysician->address_line_1) ? $attendingPhysician->address_line_1 : 'N/A' }}</span>
                </div>
                <div class="col">
                    <label for="physician_telephone">Telephone:</label>
                    <span id="physician_telephone">{{ !empty($attendingPhysician->primary_phone) ? $attendingPhysician->primary_phone : 'N/A' }}</span>
                </div>
                <div class="col">
                    <label for="physician_fax">Fax:</label>
                    <span id="physician_fax">{{ !empty($attendingPhysician->fax) ? $attendingPhysician->fax : 'N/A' }}</span>
                </div>
            </div>
            <div class="row mt-4">
                <div class="col-md-5">
                ...
                @php
                    $referringPhysician = $physicians->where('id', $pat->extra_info->referring_physician_id)->first();
                @endphp
                <div class="mt-4">
                    <div class="col">
                        <label for="physician_name_alt">Physician Name:</label>
                        <span id="physician_name_alt">{{ !empty($referringPhysician) ? $referringPhysician->first_name.' '.$referringPhysician->last_name : '' }}</span>
                    </div>
                    <div class="col">
                        <label for="physician_address">Address:</label>
                        <span id="physician_address_alt">{{ !empty($referringPhysician->address_line_1) ? $referringPhysician->address_line_1 : '' }}</span>
                    </div>
                    <div class="col">
                        <label for="physician_telephone">Telephone:</label>
                        <span id="physician_telephone_alt">{{ !empty($referringPhysician->primary_phone) ? $referringPhysician->primary_phone : '' }}</span>
                    </div>
                    <div class="col">
                        <label for="physician_fax">Fax:</label>
                        <span id="physician_fax_alt">{{ !empty($referringPhysician->fax) ? $referringPhysician->fax : '' }}</span>
                    </div>
                </div>
            </div>
            <hr class="hr-st">
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="form-group">
                        <input type="checkbox"
                            name="face_to_face_evaluation[]"
                            value="na"
                            id="face_to_face_evaluation"
                            class="form-control"
                            @if(!is_null($pat->extra_info->face_to_face_evaluation) && (in_array('na', json_decode($pat->extra_info->face_to_face_evaluation)) || empty($pat->extra_info->face_to_face_evaluation))) checked @endif>


                        <label for="face_to_face_evaluation_na">NA</label>
                    </div>
                    <div class="form-group">
                        <input type="checkbox" name="face_to_face_evaluation[]" value="date" id="face_to_face_evaluation_date"
                               class="form-control"
                               @if(!is_null($pat->extra_info->face_to_face_evaluation) && (in_array('date', json_decode($pat->extra_info->face_to_face_evaluation)) || empty($pat->extra_info->face_to_face_evaluation))) checked @endif>
                        ...
                        <input class="face_to_face" type="date" name="faceVsitDate"
                               value="{{ $pat->extra_info->faceVsitDate }}">
                    </div>
                    <div class="form-group">
                        <input type="checkbox" name="face_to_face_evaluation[]"
                               value="face_to_face_evaluation_completed" id="face_to_face_completed"
                               class="form-control"
                               @if(!is_null($pat->extra_info->face_to_face_evaluation) && (in_array('face_to_face_evaluation_completed', json_decode($pat->extra_info->face_to_face_evaluation)) || empty($pat->extra_info->face_to_face_evaluation))) checked @endif>
                        <label for="face_to_face_evaluation_completed">Face-to-Face to be completed within 30 days</label>
                    </div>
                </div>
            </div>
        </div>
...
<form class="patientEmergencyPreparednessForm" name="patientEmergencyPreparednessForm" id="patientEmergencyPreparednessForm" method="post">
    @csrf
    <div class="vt card mb-2 tabcontent" id="emergency">
        <div class="card-header text-center !bg-[#4133BF]">
        ...
        <div class="row mt-3">
            <div class="col">
                ...
                <input id="emergency_first_name" type="text" class="form-control s ou" name="emergency_first_name" value="{{ !empty($pat->emergencyContact->name) ? $pat->emergencyContact->name : '' }}">
            </div>
            <div class="col">
                <label for="emergency_relationship_patient">Relationship to patient</label>
                <input id="emergency_relationship_patient" type="text" class="form-control s ou" name="emergency_relationship_patient" value="{{ !empty($pat->emergencyContact->relationship_to_patient) ? $pat->emergencyContact->relationship_to_patient : '' }}">
            </div>
            <div class="col">
                <label for="emergency_patient_address">Address:</label>
                <input id="emergency_patient_address" type="text" class="form-control s ou" name="emergency_patient_address" value="{{ !empty($pat->emergencyContact->address) ? $pat->emergencyContact->address : '' }}">
            </div>
        </div>
        ...
        <div class="row mt-2">
            <div class="form-group col">
                ...
                <input id="emergency_patient_city" type="text" placeholder="Enter City Name" class="form-control s ou" name="emergency_patient_city" value="{{ !empty($pat->emergencyContact->city) ? $pat->emergencyContact->city : '' }}">
            </div>
            <div class="form-group col">
                <label for="emergency_patient_state">State: </label>
                <input id="emergency_patient_state" type="text" placeholder="Enter State Name" class="form-control s ou" name="emergency_patient_state" value="{{ !empty($pat->emergencyContact->state) ? $pat->emergencyContact->state : '' }}">
            </div>
            <div class="form-group col">
                <label for="emergency_patient_zip">Zip: </label>
                <input id="emergency_patient_zip" type="text" placeholder="Enter Zipcode" class="form-control s ou" name="emergency_patient_zip" value="{{ !empty($pat->emergencyContact->zip) ? $pat->emergencyContact->zip : '' }}">
            </div>
        </div>
        ...
        <div class="row mt-2">
            <div class="form-group col-md-4">
                ...
                <input id="emergency_patient_phone" type="text" placeholder="Enter Phone Number" class="form-control s ou" name="emergency_patient_phone" value="{{ !empty($pat->emergencyContact->phone) ? $pat->emergencyContact->phone : '' }}">
            </div>
            <div class="form-group col-md-4">
                <div class="form-group">
                    <label for="emergency_alternate_phone">Alternate Phone: </label>
                    <input id="emergency_alternate_phone" type="text" placeholder="Enter Alternate Phone" class="form-control s ou" name="emergency_alternate_phone" value="{{ !empty($pat->emergencyContact->alternate_phone) ? $pat->emergencyContact->alternate_phone : '' }}">
                </div>
            </div>
        </div>
        ...
        <div class="row mt-3">
            <div class="col">
                ...
                <input id="emergency_alternate_first_name" type="text" class="form-control s ou" name="emergency_alternate_first_name" value="{{ !empty($pat->emergency) ? $pat->emergency->name : '' }}">
            </div>
            <div class="col">
                <label for="emergency_relationship_to_patient">Relationship to patient</label>
                <input id="emergency_relationship_to_patient" type="text" class="form-control s ou" name="emergency_relationship_to_patient" value="{{ !empty($pat->emergency) ? $pat->emergency->relationship_to_patient : '' }}">
            </div>
            <div class="col">
                <label for="emergency_relationship_address">Address:</label>
                <input id="emergency_relationship_address" type="text" class="form-control s ou" name="emergency_relationship_address" value="{{ !empty($pat->emergency) ? $pat->emergency->address : '' }}">
            </div>
        </div>
        ...
        <div class="row mt-2">
            <div class="form-group col">
                ...
                <input id="emergency_relationship_city" type="text" placeholder="Enter City Name" class="form-control s ou" name="emergency_relationship_city" value="{{ !empty($pat->emergency) ? $pat->emergency->city : '' }}">
            </div>
            <div class="form-group col">
                <div class="form-group">
                    <label for="emergency_relationship_state">State: </label>
                    <input id="emergency_relationship_state" type="text" placeholder="Enter State Name" class="form-control s ou" name="emergency_relationship_state" value="{{ !empty($pat->emergency) ? $pat->emergency->state : '' }}">
                </div>
            </div>
            <div class="form-group col">
                <div class="form-group">
                    <label for="emergency_relationship_zip">Zip: </label>
                    <input id="emergency_relationship_zip" type="text" placeholder="Enter Zipcode" class="form-control s ou" name="emergency_relationship_zip" value="{{ !empty($pat->emergency) ? $pat->emergency->zip : '' }}">
                </div>
            </div>
        </div>
        ...
        <div class="row mt-2">
            <div class="form-group col-md-4">
                ...
                <input id="emergency_relationship_phone" type="text" placeholder="Enter Phone Number" class="form-control s ou" name="emergency_relationship_phone" value="{{ !empty($pat->emergency) ? $pat->emergency->phone : '' }}">
            </div>
            <div class="form-group col-md-4">
                <div class="form-group">
                    <label for="emergency_relationship_alternate_phone">Alternate Phone: </label>
                    <input id="emergency_relationship_alternate_phone" type="text" placeholder="Enter Alternate Phone" class="form-control s ou" name="emergency_relationship_alternate_phone" value="{{ !empty($pat->emergency) ? $pat->emergency->alternate_phone : '' }}">
                </div>
            </div>
        </div>
        ...
        <hr class="hr-st">
        @php
            $emergencyPreparednessArray = !empty($pat->extra_info->emergency_preparedness) ? json_decode($pat->extra_info->emergency_preparedness, true) : [];
        @endphp
...
<form class="patientInsuranceForm" name="patientInsuranceForm"
    ...
    @csrf
    <div class="vt card mb-2 tabcontent" id="insurance">
        <div class="card-header text-center !bg-[#4133BF]">
        ...
        <div class="row mt-3">
            ...
            <div class="row mt-2">
                ...
                <div class="col-md-3">
                    <input class="w-full" name="co_pay_money" type="text" value="{{ !empty($pat->insurance->co_pay) ? $pat->insurance->co_pay : '' }}"/>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-2">
                ...
                <div class="col-md-2">
                    <input type="checkbox" name="private_pay" id="private_pay" class="form-control" {{ isset($pat->insurance->private_pay) && $pat->insurance->private_pay  ? 'checked' : '' }}>
                </div>
            </div>
        </div>
        <div class="row mt-4">
                ...
                <div class="col-md-5">
                    <div class="col-md-5">
                        <input id="insurance_medicaid_member_id" type="text" class="form-control s ou"
                            name="insurance_medicaid_member_id" value="{{ old('insurance_medicaid_member_id', !empty($pat->insurance->medicaid_id) ? $pat->insurance->medicaid_id : '') }}">
                    </div>
                </div>
            </div>
            <div class="row mt-2">
                ...
                <div class="col-md-5">
                    <input id="insurance_medicare_member_id_check" type="text" class="form-control s ou"
                        ...
                        value="{{ old('insurance_medicare_member_id_check', !empty($pat->insurance->medicare_id) ? $pat->insurance->medicare_id : '') }}">
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-3">
                ...
                <div class="col-md-5">
                    <input id="insurance_nic_member_id_check" type="text" class="form-control s ou"
                        name="insurance_nic_member_id_check" value="{{ old('insurance_nic_member_id_check', !empty($pat->insurance->nic_id) ? $pat->insurance->nic_id : '') }}">
                </div>
            </div>
        </div>
        <div class="row mt-4">
            ...
            @php
                $paymentSource = !empty($pat->insurance->payment_source) ? json_decode($pat->insurance->payment_source, true) : [];
            @endphp
            <hr class="hr-st">
            <div class="row mt-2">
                <div class="col-md-1">
                    <input type="checkbox" name="insurance_current_payment_source[]['non_charge_current_service']"
                           ...
                           {{ ($paymentSource ?? []) && in_array('non_charge_current_service', $paymentSource) ? 'checked' : '' }}>
                </div>
                <div class="col-md-7">
            ...
            <div class="row mt-2">
                <div class="col-md-1">
                    <input type="checkbox" name="insurance_current_payment_source[]['free_for_service']"
                           ...
                           {{ ($paymentSource ?? []) && in_array('free_for_service', $paymentSource) ? 'checked' : '' }}>
                </div>
                <div class="col-md-7">
            ...
            <div class="row mt-2">
                <div class="col-md-1">
                    <input type="checkbox" name="insurance_current_payment_source[]['medicare_hmo_managed']"
                           ...
                           {{ ($paymentSource ?? []) && in_array('medicare_hmo_managed', $paymentSource) ? 'checked' : '' }}>
                </div>
                <div class="col-md-7">
            ...
            <div class="row mt-2">
                <div class="col-md-1">
                    <input type="checkbox" name="insurance_current_payment_source[]['traditional_free_service']"
                           ...
                           {{ ($paymentSource ?? []) && in_array('traditional_free_service', $paymentSource) ? 'checked' : '' }}>
                </div>
                <div class="col-md-7">
            ...
            <div class="row mt-2">
                <div class="col-md-1">
                    <input type="checkbox" name="insurance_current_payment_source[]['insurance_medicaid_hmo_managed']"
                           ...
                           {{ ($paymentSource ?? []) && in_array('insurance_medicaid_hmo_managed', $paymentSource) ? 'checked' : '' }}>
                </div>
                <div class="col-md-7">
                    <label for="insurance_medicaid_hmo_managed">Medicaid (HMO/Managed)</label>
                </div>
            </div>
            <!-- Add similar blocks for other checkboxes with empty checks -->
            ...
            <div class="row mt-2">
                <div class="col-md-1">
                    <input type="checkbox" name="insurance_current_payment_source[]['insurance_workers_compensation']"
                           ...
                           {{ in_array('insurance_workers_compensation', $paymentSource ?? []) ? 'checked' : '' }}>
                </div>
                <div class="col-md-7">
            ...
            <div class="row mt-2">
                <div class="col-md-1">
                    <input type="checkbox" name="insurance_current_payment_source[]['insurance_program_111']"
                           ...
                           {{ in_array('insurance_program_111', $paymentSource ?? []) ? 'checked' : '' }}>
                </div>
                <div class="col-md-7">
            ...
            <div class="row mt-2">
                <div class="col-md-1">
                    <input type="checkbox" name="insurance_current_payment_source[]['other_government']"
                           ...
                           {{ in_array('other_government', $paymentSource ?? []) ? 'checked' : '' }}>
                </div>
                <div class="col-md-7">
            ...
            <div class="row mt-2">
                <div class="col-md-1">
                    <input type="checkbox" name="insurance_current_payment_source[]['private_insurance']"
                           ...
                           {{ in_array('private_insurance', $paymentSource ?? []) ? 'checked' : '' }}>
                </div>
                <div class="col-md-7">
            ...
            <div class="row mt-2">
                <div class="col-md-1">
                    <input type="checkbox" name="insurance_current_payment_source[]['private_hmo_care']"
                           ...
                           {{ in_array('private_hmo_care', $paymentSource ?? []) ? 'checked' : '' }}>
                </div>
                <div class="col-md-7">
            ...
            <div class="row mt-2">
                <div class="col-md-1">
                    <input type="checkbox" name="insurance_current_payment_source[]['self_pay']" id="selft_pay"
                           class="form-control" {{ in_array('self_pay', $paymentSource ?? []) ? 'checked' : '' }}>
                </div>
                <div class="col-md-7">
            ...
            <div class="row mt-2">
                <div class="col-md-1">
                    <input type="checkbox" name="insurance_current_payment_source[]['other_specify']" id="other_specify"
                           class="form-control"
                           {{ in_array('other_specify', $paymentSource ?? []) ? 'checked' : '' }}>
                </div>
                <div class="col-md-2">
            ...
            <div class="row mt-2">
                <div class="col-md-1">
                    <input type="checkbox" name="insurance_current_payment_source[]['unknown_resource']"
                           id="unknown_resource" class="form-control" {{ in_array('unknown_resource', $paymentSource ?? []) ? 'checked' : '' }}>
                </div>
                <div class="col-md-2">
...
<form class="patientEpisodeForm" name="patientEpisodeForm" id="patientEpisodeForm" method="post">
    @csrf
    <div class="vt card mb-2 tabcontent" id="episode">
        <div class="card-header text-center !bg-[#4133BF]">
        ...
        <div class="card-body row">
                ...
                <div class="form-group">
                    ...
                    <div class="row mt-2">
                        <div class="col">
                            ...
                            <input type="radio" name="episode_timing" value="early" id="episode_timing_early" class="form-control" {{ optional($pat->episode)->episode_timing === 'early' ? 'checked' : '' }}>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col">
                            <label class="font-normal" for="episode_timing_late">Late</label>
                            <input type="radio" name="episode_timing" value="late" id="episode_timing_late" class="form-control" {{ optional($pat->episode)->episode_timing === 'late' ? 'checked' : '' }}>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col">
                            <label class="font-normal" for="episode_timing_unknown">Unknown</label>
                            <input type="radio" name="episode_timing" value="unknown" id="episode_timing_unknown" class="form-control" {{ optional($pat->episode)->episode_timing === 'unknown' ? 'checked' : '' }}>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col">
                            <label class="font-normal" for="episode_timing_not_applicable">N/A- Not applicable: No Medicare case mix group</label>
                            <input type="radio" name="episode_timing" value="applicable" id="episode_timing_not_applicable" class="form-control" {{ optional($pat->episode)->episode_timing === 'applicable' ? 'checked' : '' }}>
                        </div>
                    </div>
            ...
            <div class="col">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <input id="episode_timing_start_care_date" type="date" class="form-control s ou" name="episode_timing_start_care_date" value="{{ optional($pat->episode)->start_care_date ?? '' }}">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <input id="episode_timing_start_date" type="date" class="form-control s ou" name="episode_timing_start_date" value="{{ optional($pat->episode)->episode_start_date ?? '' }}">
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                ...
                <div class="col-md-12">
                    <div class="col">
                        ...
                        id="living_will"
                        class="form-control"
                        {{ !is_null($advanceDirectives) && in_array('living_will', $advanceDirectives) ? 'checked' : '' }}>
                    ...
                    <input type="checkbox"
                        name="advance_directive[]"
                        value="dnr_out_hospital"
                        id="dnr_out_hospital"
                        class="form-control"
                        {{ !is_null($advanceDirectives) && in_array('dnr_out_hospital', $advanceDirectives) ? 'checked' : '' }}>
