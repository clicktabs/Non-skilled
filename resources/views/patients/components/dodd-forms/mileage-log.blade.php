    ...
    <div class="jj ttm vl ou uf na">
      <div class="vt container pt-5 px-4 overflow-auto">
        <div class="form-holder mt">
            ...
            <h1 class="fs-5 text-center fw-bolder position-relative mt-4" style="padding: 0 240px;">Mileage Log For Consumer</h1>

            <form action="" method="post">
                <!-- table -->
                <table class="table table-bordered align-middle text-center mb-1"> 
                    <div class="row">
                            <div class="col-md-6"><th><label for="name">License Plate#</label></th></div>
                            <div class="col-md-6"><td><input type="text" name="" id="name" class="form-control"></td></div>
                    </div>                  
                        <div class="row">
                            <div class="col-md-6"><th><label for="ISPDate">House Street Address</label></th></th></div>
                            <div class="col-md-6"><td><input type="text" name="" id="name" class="form-control"></td></div>
                        </div>
                </table>
                <!-- table -->
                <table class="table table-bordered align-middle text-center mt-1 padding-thin input-padding-thin" id="append-rows">
                    <tr class="align-top">
                        <th style="width: 180px;"><b>Date</b><br></th>
                        <th style="width: 300px;">Eployee</th>
                        <th style="width: 300px;">Consumer Name</th>
                        <th>Beginning Mileage</th>
                        <th>Ending Mileage</th>
                        <th>Total Mileage</th>
                        <th style="width: 450px;">Office Use Only</th>
                        <th style="width: 450px;">Comment / Purpose</th>
                    </tr>
                </table>
