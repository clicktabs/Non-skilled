...
{{--                                                <li><a href="#signature">Signature</a></li>--}}
                                        ...
                                        <div id="main">
                                            ...
                                            <div class="patient_status_table pb-5 !px-[15px]" style="margin-top: -4em;">
                                                <div class="patient_table">
                                                    <table class="table-responsive display nowrap" style="width:100%" id="taskTableList">
                                                        <thead class=" text-[#fff] bg-[#4133BF]">
                                                        <tr>
                                                            <th>Task</th>
                                                            <th>Schedule Date</th>
                                                            <th>Assigned By</th>
...
{{--                                        <div id="activities" class="mt-[30px]">--}}
{{--                                            <table id="activities_table" class="pt-[30px]">--}}
...
{{--                                                                  action="{{ route('employee-activities.destroy', $activity->id) }}"--}}
{{--                                                                  method="POST">--}}
{{--                                                                @csrf--}}
{{--                                                                @method('DELETE')--}}
...
{{--                                            </table>--}}
{{--                                        </div>--}}
{{--                                        <div id="activitiesModal" class="max-w-[450px]">--}}
{{--                                            <form>--}}
{{--                                                <div class="row">--}}
{{--                                                    <div class="col-md-6">--}}
...
{{--                                                    </div>--}}
{{--                                                    <div class="col-md-6">--}}
{{--                                                        <label for="activities_type">Type</label>--}}
{{--                                                        <select class="form-control" id="activities_type"--}}
...
{{--                                                    </div>--}}
{{--                                                    <div class="col-md-6">--}}
{{--                                                        <label for="activities_share_level">Share level</label>--}}
{{--                                                        <select class="form-control" id="activities_share_level"--}}
{{--                                                                name="activities_share_level">--}}
...
{{--                                                <div class="row">--}}
{{--                                                    <div class="col-md-12">--}}
{{--                                                        <label for="activities_notes">Notes</label>--}}
{{--                                                        <textarea id="activities_notes" name="activities_notes" cols="5"--}}
...
{{--                                        @include('employees.components.matching', ['employee' => $employee, 'caregivers'=> $caregivers])--}}
{{--                                        @include('employees.components.attachment', ['employee' => $employee, 'caregivers'=> $caregivers])--}}
                                    </div>
                                </div>
                            </div>
                        </div>
