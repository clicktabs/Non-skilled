...
<!-- Welcome banner -->
<div class="y pr dw jk rounded-sm la rc !bg-[#2c3e75]">
...
@if(!$user->hasRole('super-admin') && $current_user)
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-md-10">
                            <div class="row h-full">
                                <div class="col-lg-6">
                                    <div class="patient_info_content fw-bolder">
                                        <div class="patient_info_content_header d-flex align-items-center">
    ...
    <div id="employee_info_tabs" class="mt-[0px] bg-[#fff]" style="margin-top: -30px;">
        <ul class="d-flex flex-nowrap align-items-center gap-3  py-[10px] px-[20px] mb-3 bg-[#2c3e75] " >
            ...
            <div class="bg-white bd rounded-sm border border-slate-200 mt-2">
                <div class="dk">
                    <table class="client_table ux ou display nowrap" style="width:100%" id="schedulingList">
                        <thead class="bg-[#2c3e75] text-[#fff]">
                            <tr>
                                <th>Patient Name</th>
                                <th>Start Date</th>
                                <th>End Date</th>
