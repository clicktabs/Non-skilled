...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('etransfers', function (Blueprint $table) {
            ...
            $table->string('resumption_of_care')->nullable();
            $table->string('recertification')->nullable();
            $table->string('otherFollowUp')->nullable();
            $table->string('transferredNotDischarged')->nullable();
            $table->string('transferredDischarged')->nullable();
            $table->string('deathAtHome')->nullable();
            $table->string('dischargeFromAgency')->nullable();
